...
"""
Default configuration for LMFTrack.
"""
cfg = edict()

# MODEL
cfg.MODEL = edict()
cfg.MODEL.PRETRAIN_FILE = "LMFTrack_SOT_Pretrained.pth.tar"
...
cfg.MODEL.BACKBONE.TYPE = "vit_base_patch16_224_lmftrack"
...
# RGBT.BACKBONE
cfg.MODEL.BACKBONE.FUSION_LOC = [3, 6, 9]
...
# Cross-modal fusion
cfg.TRAIN.FUSION_DROP_RATE = 0.  # dropout rate for TransformerDecoderLayer
cfg.TRAIN.FUSION_DROP_PATH = [0.0, 0.0, 0.0]  # drop-path rates for cross-modal fusion blocks
cfg.TRAIN.SOT_PRETRAIN = True  # SOT pretraining with shared backbones
...
cfg.TEST.EPOCH = 15
cfg.TEST.TEMPLATE_UPDATE_THRESHOLD = 0.88
